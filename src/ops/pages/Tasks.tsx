...
function TaskDisplayRow({
  ...
  return (
    <div
      ...
      className={cn(
        'grid grid-cols-1 items-center gap-x-4 gap-y-2 px-4 py-3.5 transition-colors md:grid-cols-[2rem_1fr_10rem_10rem_12rem_8rem_7rem_9rem_8rem]',
        canEdit ? 'cursor-pointer hover:bg-muted/40' : 'cursor-default',
    ...
    >
      <button
        ...
        className={cn(
          ...
          task.completed ? 'border-green-600 bg-green-600 text-white' : 'border-border text-transparent',
          canEdit ? 'hover:border-gc-orange' : 'cursor-not-allowed opacity-45',
        )}
        disabled={!canEdit}
